...
\title{Curriculum Vitae - Diciembre 2023}                               % optional, remove / comment the line if not wanted
...
\social[github]{jjclavijo}                              % optional, remove / comment the line if not wanted
...
\cventry{2022-2023}{Co-Dirección Tesis de Grado}{Federico Fernandez Caruso, Director: Dr. Sebastián Grynberg}{}{}{Resolución de ambigüedades de fase de observaciones GPS sin detección previa de saltos de ciclo}
...
\cvitem{Clavijo JJ \\ Martínez JF } {\textit{Adversarial learning of permanent seismic deformation from GNSS coordinate time series} 2023. Computers \& Geocsiences. \url{https://doi.org/10.1016/j.cageo.2023.105344} }

\subsection{Proyectos de desarrollo}
...
\cvitem{Clavijo JJ } {\textit{Möbius y la tectónica o interpolar procesos en espacios transformados} Argentina. Buenos Aires. 2023. IV Jornadas de Geociencias para la Ingeniería, Facultad de Infeniería - Universidad de Buenos Aires }

\cvitem{Clavijo JJ } {\textit{Innovación tecnológica y paradigmas de enseñanza en Cartografía} Argentina. Buenos Aires. 2023. XVIII Semana Nacional de la Cartografía, Centro argentino de cartografía. }
...
\section{Informática}
\cvdoubleitem{Programación}{Python, C, Lisp, Rust, awk, bash, Haskell}{Bases de Datos}{Postgres}
